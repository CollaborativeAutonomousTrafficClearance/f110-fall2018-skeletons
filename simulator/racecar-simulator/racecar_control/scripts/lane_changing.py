...
class LaneChange:
    ...
    def __init__(self):
        ...
        *:= the ego vehicle
        ...
        self.vehicle_length = 0.58 # length of vehicles - please adjust this value if another vehicle model is used - value could be increased than actual to enforce a greater minimal gap between vehicles ################## rospy.get_param('')
    ...
    def isSafeWRTD(self):
        ...
        vehicle_D_max_ACC = self.my_vehicle_ids.ids[self.vehicle_D].max_acc
...
if __name__ == "__main__":
    rospy.init_node("lane_change")

    # create object of class LaneChange
    lc = LaneChange()

    # subscribe to '/vesc/odom'
    rospy.Subscriber('/vesc/odom', Odometry, lc.odomCallback, queue_size=2)
    # subscribe to 'ids_combined'
    rospy.Subscriber('ids_combined', IDsCombined, lc.idsCallback, queue_size=2)
